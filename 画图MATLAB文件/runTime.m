...
IMPN_runtime=[2.425,8.046,29.380,187.177,509.656,866.591,3500.291,23879.155];

plot(x,SNM_runtime,'-* b', x,MPN_runtime,'-V g', x,IMPN_runtime,'-s r')%画图命令
axis( [0,500,0,23880] );%横纵坐标的坐标取值范围
xlabel('数据规模(千)');%横坐标名字
